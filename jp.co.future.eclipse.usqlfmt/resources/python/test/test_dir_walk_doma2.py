...
def __setup_tests():
    ...
    root = curr[0:i]
    testfiles = os.path.join(root, "testfiles", "doma2")
    test_target = os.path.join(testfiles, "test")
    test_out = os.path.join(root, "sql-formatter-for-python", "target", "testout", "doma2")
    ...
    local_config.set_commentsyntax(Doma2CommentSyntax())
